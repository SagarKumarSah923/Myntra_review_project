...
from src.cloud_io import SQLiteIO  # changed from MongoIO to SQLiteIO
...
def form_input():
    ...
    if st.button("Scrape Reviews"):
        ...
        if scrapped_data is not None:
            ...
            sqliteio = SQLiteIO()  # changed from mongoio = MongoIO()
            sqliteio.store_reviews(product_name=product,
                                   reviews=scrapped_data)
            print("Stored Data into SQLite")
